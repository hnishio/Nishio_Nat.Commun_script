...
pdf("figs/K4-K27_Lissajous_ACT2_STM_1st_year.pdf",width=3.4,height=3.5)	
par(ps=6)
par(mfrow=c(3,3))
par(oma=c(1,0,0,0))
...
par(ps=5)
textxy(nor(x2[c(1:18,24),"K4_I_ACT2_mean"]),
...
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_I_STM_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0,0.7,1),las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n")

#amplicon II
par(new=T)
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_II_STM_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0,0.2,0.5),las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon III
par(new=T)
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_III_STM_mean"],type="o",
     pch=16,cex=0.5,col=rgb(1,0,0.2),las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon IV
par(new=T)
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_IV_STM_mean"],type="o",
     pch=16,cex=0.5,col="orange",las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon V
par(new=T)
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_V_STM_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0.6,0.3,0.6),las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon VI
par(new=T)
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_VI_STM_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0,0.6,0),las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon VII
par(new=T)
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_VII_STM_mean"],type="o",
     pch=16,cex=0.5,col=rgb(1,0,1),las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon VIII
par(new=T)
plot(x2[,"K4_I_ACT2_mean"], x2[,"K27_VIII_STM_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0.55,0,0),las=1,tcl=-0.1, xlim=c(0,1.1),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)
