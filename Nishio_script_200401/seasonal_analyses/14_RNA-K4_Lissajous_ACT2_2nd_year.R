...
pdf("figs/RNA-K4_Lissajous_ACT2_2nd_year.pdf",width=3.3,height=2.4)	
par(ps=6)
par(mfrow=c(2,3))
par(oma=c(1,1,0,0))
...
textxy(nor(x2[c(1:18,26),"FLC.log10mean"]),
       nor(x2[c(1:18,26),"K4_I_ACT2_mean"]),
       c(1:18,26),cex=1)	
...
par(ps=5)
textxy(nor(x2[c(1:18,26),"FLC.log10mean"]),
       nor(x2[c(1:18,26),"K4_II_ACT2_mean"]),
       c(1:18,26),cex=1)	
...
par(ps=5)
textxy(nor(x2[c(1:18,26),"FLC.log10mean"]),
       nor(x2[c(1:18,26),"K4_VI_ACT2_mean"]),
       c(1:18,26),cex=1)	
...
par(ps=5)
textxy(nor(x2[c(1:18,26),"FLC.log10mean"]),
       nor(x2[c(1:18,26),"K4_VII_ACT2_mean"]),
       c(1:18,26),cex=1)	
...
par(ps=5)
textxy(nor(x2[c(1:18,26),"FLC.log10mean"]),
       nor(x2[c(1:18,26),"K4_VIII_ACT2_mean"]),
       c(1:18,26),cex=1)	
...
plot(x2[,"FLC.log10mean"], x2[,"K4_I_ACT2_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0,0.7,1),las=1,tcl=-0.1, xlim=c(-2.5,0.5),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n")

#amplicon II
par(new=T)
plot(x2[,"FLC.log10mean"], x2[,"K4_II_ACT2_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0,0.2,0.5),las=1,tcl=-0.1, xlim=c(-2.5,0.5),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon VI
par(new=T)
plot(x2[,"FLC.log10mean"], x2[,"K4_VI_ACT2_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0,0.6,0),las=1,tcl=-0.1, xlim=c(-2.5,0.5),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon VII
par(new=T)
plot(x2[,"FLC.log10mean"], x2[,"K4_VII_ACT2_mean"],type="o",
     pch=16,cex=0.5,col=rgb(1,0,1),las=1,tcl=-0.1, xlim=c(-2.5,0.5),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)

# amplicon VIII
par(new=T)
plot(x2[,"FLC.log10mean"], x2[,"K4_VIII_ACT2_mean"],type="o",
     pch=16,cex=0.5,col=rgb(0.55,0,0),las=1,tcl=-0.1, xlim=c(-2.5,0.5),ylim=c(0,1.1),
     xlab="",ylab="",xaxt="n",yaxt="n",axes=F, ann=F)
